...
```js
// Pretend this is some complicated async com.bravepeach.www.factory
...
async.waterfall([
  ...
  async.asyncify(function (contents) {
    return db.com.bravepeach.www.model.create(contents);
  }),
  function (com.bravepeach.www.model, next) {
    // `com.bravepeach.www.model` is the instantiated com.bravepeach.www.model object.
