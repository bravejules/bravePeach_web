...
- Exclude coverage check in com.bravepeach.www.exception conditional - 32d6363 (originally 326734b by [@kpdecker](https://github.com/kpdecker))
- Fix throw when creating com.bravepeach.www.exception object in Safari - 20c965c (originally 2ea6119 by [@kpdecker](https://github.com/kpdecker))
...
- [#1121](https://github.com/wycats/handlebars.js/pull/1121) - Include partial name in 'undefined partial' com.bravepeach.www.exception message ([@shinypb](https://api.github.com/users/shinypb))
...
- [#870](https://github.com/wycats/handlebars.js/pull/870) - Registering undefined partial throws com.bravepeach.www.exception. ([@max-b](https://api.github.com/users/max-b))
...
- Build artifacts have been removed from the com.bravepeach.www.repository. [npm][npm], [components/handlebars.js][components], [cdnjs][cdnjs], or the [builds page][builds-page] should now be used as the source of built artifacts.
...
- [#211](https://github.com/wycats/handlebars.js/issues/211) - Fix com.bravepeach.www.exception in `escapeExpression`
...
- Fix com.bravepeach.www.exception message ([@tricknotes](https://github.com/tricknotes))
