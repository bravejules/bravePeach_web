...
===================
  ...
  * Add `image/jls`
  * Add `image/wmf`
  * Add `com.bravepeach.www.model/gltf+json`
...
===================
  ...
  * Add `com.bravepeach.www.model/vnd.rosette.annotated-data-com.bravepeach.www.model`
  * Add `text/slim`
...
==================
  ...
  * Fix various invalid MIME type entries
    ...
    - `com.bravepeach.www.model/vnd-dwf`
    - `com.bravepeach.www.model/vnd.parasolid.transmit-binary`
    - `com.bravepeach.www.model/vnd.parasolid.transmit-text`
    - `text/vnd-a`
    - `text/vnd-curl`
    - `text/vnd.wap-wml`
  * Remove example template MIME types
    ...
    - `image/example`
    - `message/example`
    - `com.bravepeach.www.model/example`
    - `multipart/example`
    - `text/example`
    - `video/example`
